...
-	0.0000 1100 1100 1100 1100 110	11 000
=	1.0010 0011 1110 1110 1000 111

 00110000101110110101101
-	00001100110011001100110
= 0010 0011 1110 1110 1000 111
com	0010 0011 1110 1110 1000 110
...
相减：计算器去掉小数点和前面的
 1.00110000101110110101101
-	0.00001100110011001100110	10010
=	1.00100011111011101000111
=	1.0010 0011 1110 1110 1000 111
com	1.0010 0011 1110 1110 1000 110
...
**小结：**
* 计算的结果的确是一样的，但是和最终的4.76143503还是有点不一样，这说明我手动计算和机器计算还是有点区别，包括后面的规格化，舍入我就没去细看了，留个问题在这里吧
```
